...
public class PlayerBehaviourLuffy : NetworkBehaviour
{
  ...
  void Attack()
  {
    ...
    {
      if (enemy.GetComponent<PlayerBehaviourChopper>() != null)
      {
        enemy.GetComponent<PlayerBehaviourChopper>().TakeDamage(attackDamage, firstAtkPower);
        break;
      }
